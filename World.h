...
World::World(sf::Vector2u l_windSize){
    ...
    RespawnFruit();
    m_fruitShape.setFillColor(sf::Color::Red);
    m_fruitShape.setRadius(m_blockSize/2);
...
void World::RespawnFruit(){
    ...
    m_fruitShape.setPosition(m_item.x * m_blockSize, m_item.y * m_blockSize);
}
